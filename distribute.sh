...
find $ACEXPANDER_DISTRIBUTE_DIR -type f | \
   egrep -v "(CVS|.svn|.DS_Store|$MYNAME|$ACEXPANDER_DISTRIBUTE_DIR/build|$ACEXPANDER_DISTRIBUTE_DIR/Archive|$ACEXPANDER_DISTRIBUTE_DIR/Testfiles|$ACEXPANDER_DISTRIBUTE_DIR/Graphics|$ACEXPANDER_DISTRIBUTE_DIR/doxygen|$ACEXPANDER_DISTRIBUTE_DIR/UML)" \
   >$TMPFILE
ls $ACEXPANDER_DISTRIBUTE_DIR/Graphics/*.icns >>$TMPFILE
ls $ACEXPANDER_DISTRIBUTE_DIR/doxygen/Doxyfile >>$TMPFILE
ls $ACEXPANDER_DISTRIBUTE_DIR/UML/*.mdzip >>$TMPFILE
ls $ACEXPANDER_DISTRIBUTE_DIR/UML/*.png >>$TMPFILE
