...
find $ACEXPANDER_DISTRIBUTE_DIR -type f | \
   egrep -v "(CVS|.git|.DS_Store|$MYNAME|$ACEXPANDER_DISTRIBUTE_DIR/build|$ACEXPANDER_DISTRIBUTE_DIR/Archive|$ACEXPANDER_DISTRIBUTE_DIR/Testfiles|$ACEXPANDER_DISTRIBUTE_DIR/Graphics|$ACEXPANDER_DISTRIBUTE_DIR/doxygen|$ACEXPANDER_DISTRIBUTE_DIR/UML)" \
   >$TMPFILE
